...
public class Joint extends Account {
	...
	public void read() {
		...
		System.out.println("Please Enter Account Holder 1 Detail :");
		nameOne.read();
		System.out.println("Please Enter Account Holder 1 Detail :");
		nameTwo.read();
	...
	public String toString() {
		...
		return "Account No " + getAccountNumber() + " nameOne=" + nameOne + ", nameTwo=" + nameTwo + " " + address
				+ ", accountNumber=" + accountNumber + ", balance=" + balance + ", dateOpened=" + dateOpened;
	}
